#!/usr/bin/env python3
"""Bridge between YOUSEF SHTIWE OAuth token and gws CLI.
...
def get_yousef shtiwe_home() -> Path:
    return Path(os.environ.get("YOUSEF SHTIWE_HOME", Path.home() / ".yousef shtiwe"))


def get_token_path() -> Path:
    return get_yousef shtiwe_home() / "google_token.json"
