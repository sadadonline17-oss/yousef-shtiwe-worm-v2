...
metadata:
  yousef shtiwe:
    ...
    related_skills: [claude-code, yousef shtiwe-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the YOUSEF SHTIWE terminal. Codex is OpenAI's autonomous coding agent CLI.
