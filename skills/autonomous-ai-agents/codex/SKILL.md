...
metadata:
  shadow:
    ...
    related_skills: [claude-code, shadow-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the SHADOW terminal. Codex is OpenAI's autonomous coding agent CLI.
