...
curl -s -X POST \
  ...
  -d "{
    \"commit_id\": \"$HEAD_SHA\",
    \"event\": \"COMMENT\",
    \"body\": \"Code review from YOUSEF SHTIWE Agent\",
    \"comments\": [
...
```bash
source ~/.yousef shtiwe/skills/github/github-auth/scripts/gh-env.sh
...
gh pr review $PR_NUMBER --approve --body "Reviewed by YOUSEF SHTIWE Agent. Code looks clean — good test coverage, no security concerns."
...
curl -s -X POST \
  ...
  -d "{
    ...
    \"body\": \"## YOUSEF SHTIWE Agent Review\n\nFound 2 issues, 1 suggestion. See inline comments.\",
    \"comments\": [
...
---
*Reviewed by YOUSEF SHTIWE Agent*
EOF
)"
```
