...
## YOUSEF SHTIWE Agent Integration

This skill is designed for the YOUSEF SHTIWE agent. It uses YOUSEF SHTIWE tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other YOUSEF SHTIWE skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.yousef shtiwe/plans/` | `skill_view("plan")` |
