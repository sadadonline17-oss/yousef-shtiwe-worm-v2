...
Built for [SHADOW Agent](https://github.com/NousResearch/shadow-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/shadow-agent/skills/creative/ascii-video`](https://github.com/NousResearch/shadow-agent/tree/main/skills/creative/ascii-video) via PR.
