      ...
      <div className={styles.overlay}>
        <div className={styles.card}>
          ...
          <div className={styles.welcomeHeader}>
            <Image src="/logo.png" alt="yousef_shtiwe" width={36} height={36} style={{ objectFit: 'contain' }} />
          ...
          <div className={styles.body}>
            <p className={styles.welcomeThank}>
              Thank you for downloading and installing <strong>yousef_shtiwe</strong>!
            </p>

            <p className={styles.welcomeDesc}>
              <strong>yousef_shtiwe</strong> is an open-source, AI-powered
            ...
            <div className={styles.missionBox}>
              <p className={styles.missionText}>
                Our commitment is to keep yousef_shtiwe always up-to-date and make it
            ...
            >
              ...
              <span>Star yousef_shtiwe on GitHub</span>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.body}>
          <p className={styles.intro}>
            <strong>yousef_shtiwe</strong> is an AI-powered penetration testing
