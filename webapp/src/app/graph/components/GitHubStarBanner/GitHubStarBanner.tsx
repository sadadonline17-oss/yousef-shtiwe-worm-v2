...
const STORAGE_KEY = 'yousef_shtiwe-github-star-dismissed'
  ...
  return (
    <div className={styles.banner}>
      ...
      <span className={styles.text}>
        Enjoying yousef_shtiwe? A <a href="https://github.com/samugit83/yousef_shtiwe" target="_blank" rel="noopener noreferrer">GitHub star</a> helps others discover the project.
      </span>
