...
export function AIAssistantDrawer({
  ...
  const handleDownloadMarkdown = useCallback(() => {
    ...
    a.href = url
    a.download = `yousef_shtiwe-session-${timestamp}.md`
    a.click()
        ...
        {chatItems.length === 0 && (
          <div className={styles.emptyState}>
            <div className={styles.emptyIcon}>
              <img src="/logo.png" alt="yousef_shtiwe" width={72} height={72} style={{ objectFit: 'contain' }} />
            </div>
          ...
          <div className={`${styles.message} ${styles.messageAssistant}`}>
            <div className={`${styles.messageIcon} ${styles.loadingEyeIcon}`}>
              <div className={styles.eyeContainer}>
                <img src="/logo.png" alt="yousef_shtiwe" width={34} height={21} className={styles.loadingEye} ref={eyeRef} />
