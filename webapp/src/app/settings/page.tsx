...
export default function SettingsPage() {
  ...
  const downloadKeysTemplate = useCallback(() => {
    ...
    const a = document.createElement('a')
    a.href = url
    a.download = 'yousef_shtiwe-api-keys-template.json'
    a.click()
    URL.revokeObjectURL(url)
    ...
    <div className={styles.page}>
      ...
      {activeTab === 'skills' && <div className={styles.section}>
        ...
        <p className={styles.sectionHint}>
          ...
          {' '}Browse <a href="https://github.com/samugit83/yousef_shtiwe/wiki/Agent-Skills#community-skills" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-primary)', textDecoration: 'underline' }}>community skills</a> for ready-to-use templates.
        </p>
...
function SystemSection() {
  ...
  const handleCopy = useCallback(() => {
    navigator.clipboard.writeText('./yousef_shtiwe.sh update').then(() => {
      setCopied(true)
    ...
    <div className={styles.section}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', fontSize: '11px' }}>
          <a
            href="https://github.com/samugit83/yousef_shtiwe/blob/master/CHANGELOG.md"
            target="_blank"
