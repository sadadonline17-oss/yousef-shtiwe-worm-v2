"""Tests for the interactive session browser (`yousef shtiwe sessions browse`).
...
from yousef shtiwe_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """yousef shtiwe sessions browse should be parseable."""
        from yousef shtiwe_cli.main import main as _main_entry
