"""Tests for yousef shtiwe claw commands."""
...
from yousef shtiwe_cli import claw as claw_mod
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.yousef shtiwe/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.yousef shtiwe/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.yousef shtiwe/migration/openclaw/20250312T120000",
        }
