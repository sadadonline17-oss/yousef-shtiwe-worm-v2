...
being persisted to ~/.yousef shtiwe/discord_threads.json.
"""
...
class TestDiscordThreadPersistence:
    ...
    def _make_adapter(self, tmp_path):
        """Build a minimal DiscordAdapter with YOUSEF SHTIWE_HOME pointed at tmp_path."""
    ...
    def test_missing_yousef shtiwe_home_does_not_crash(self, tmp_path):
        """Load/save tolerate missing directories."""
        fake_home = tmp_path / "nonexistent" / "deep"
        with patch.dict(os.environ, {"YOUSEF SHTIWE_HOME": str(fake_home)}):
