...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.yousef shtiwe/yousef shtiwe-agent/.worktrees/yousef shtiwe-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
...
async def test_run_agent_progress_stays_in_originating_topic(monkeypatch, tmp_path):
    monkeypatch.setenv("YOUSEF SHTIWE_TOOL_PROGRESS_MODE", "all")
