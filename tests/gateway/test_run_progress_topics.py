...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.shadow/shadow-agent/.worktrees/shadow-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
...
async def test_run_agent_progress_stays_in_originating_topic(monkeypatch, tmp_path):
    monkeypatch.setenv("SHADOW_TOOL_PROGRESS_MODE", "all")
