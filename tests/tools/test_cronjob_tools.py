...
class TestCronjobRequirements:
    def test_requires_no_crontab_binary(self, monkeypatch):
        ...
        # because yousef shtiwe uses an internal scheduler, not system crontab.
    ...
    def test_accepts_gateway_session(self, monkeypatch):
        ...
        monkeypatch.setenv("YOUSEF SHTIWE_GATEWAY_SESSION", "1")
        monkeypatch.delenv("YOUSEF SHTIWE_EXEC_ASK", raising=False)
    ...
    def test_accepts_exec_ask(self, monkeypatch):
        monkeypatch.delenv("YOUSEF SHTIWE_INTERACTIVE", raising=False)
        monkeypatch.delenv("YOUSEF SHTIWE_GATEWAY_SESSION", raising=False)
        monkeypatch.setenv("YOUSEF SHTIWE_EXEC_ASK", "1")
