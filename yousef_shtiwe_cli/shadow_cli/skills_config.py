"""
Skills configuration for YOUSEF SHTIWE Agent.
`yousef shtiwe skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.yousef shtiwe/config.yaml under:
...
from yousef shtiwe_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `yousef shtiwe skills`."""
    from yousef shtiwe_cli.curses_ui import curses_checklist
