...
Usage:
    yousef shtiwe pairing list              # Show all pending + approved users
    yousef shtiwe pairing approve <platform> <code>  # Approve a pairing code
    yousef shtiwe pairing revoke <platform> <user_id> # Revoke user access
    yousef shtiwe pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle yousef shtiwe pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: yousef shtiwe pairing {list|approve|revoke|clear-pending}")
        print("Run 'yousef shtiwe pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'yousef shtiwe pairing list' to see pending codes.\n")
