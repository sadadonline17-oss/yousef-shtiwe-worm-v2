"""YOUSEF SHTIWE CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.yousef shtiwe/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "YOUSEF SHTIWE Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ YOUSEF SHTIWE "       # Response box header label
...
.. code-block:: python
    ...
    from yousef shtiwe_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "YOUSEF SHTIWE Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.yousef shtiwe/skins/
...
Drop a YAML file in ``~/.yousef shtiwe/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces YOUSEF SHTIWE_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces YOUSEF SHTIWE_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic YOUSEF SHTIWE — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "YOUSEF SHTIWE Agent",
            "welcome": "Welcome to YOUSEF SHTIWE Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ YOUSEF SHTIWE ",
            "prompt_symbol": "❯ ",
...
def _skins_dir() -> Path:
    ...
    return get_yousef shtiwe_home() / "skins"
    ...
    if skins_path.is_dir():
        for f in sorted(skins_path.glob("*.yaml")):
            ...
            if data:
                ...
                # Skip if it yousef shtiwes a built-in
