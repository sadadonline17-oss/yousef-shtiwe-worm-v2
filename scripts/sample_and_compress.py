...
DEFAULT_DATASETS = [
    "YOUSEF SHTIWE-OVERLORD/swe-terminus-agent-glm-kimi-minimax",
    "YOUSEF SHTIWE-OVERLORD/yousef shtiwe-agent-megascience-sft1",
    "YOUSEF SHTIWE-OVERLORD/YOUSEF SHTIWE-Agent-Thinking-GLM-4.7-SFT2",
    "YOUSEF SHTIWE-OVERLORD/YOUSEF SHTIWE-Agent-Thinking-GLM-4.7-SFT1",
    "YOUSEF SHTIWE-OVERLORD/terminal-tasks-glm-yousef shtiwe-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "YOUSEF SHTIWE-OVERLORD/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload YOUSEF SHTIWE-OVERLORD/{output_name} {final_output}")
