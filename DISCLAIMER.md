...
yousef_shtiwe is an **educational and research tool** designed exclusively for:
...
yousef_shtiwe integrates, bundles, or invokes the following third-party open-source tools. Each tool is governed by its own license and terms. **The authors of yousef_shtiwe do not own, maintain, or provide warranty for any of these tools.** Users must independently comply with each tool's license:
