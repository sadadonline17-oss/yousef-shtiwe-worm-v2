"""
yousef_shtiwe Agent WebSocket API
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting yousef_shtiwe Agent API...")
    ...
    logger.info("yousef_shtiwe Agent API ready (WebSocket)")

    yield

    logger.info("Shutting down yousef_shtiwe Agent API...")
    if orchestrator:
        await orchestrator.close()


app = FastAPI(
    title="yousef_shtiwe Agent API",
