...
- **Phase 2: Persistence**: Secure the environment without triggering EDR/XDR alerts.
- **Phase 3: Exfiltration**: Extract high-value targets (ENV files, DB backups, SSH keys).
- **Phase 4: Neutralization**: Wipe all mission logs and disappear.
