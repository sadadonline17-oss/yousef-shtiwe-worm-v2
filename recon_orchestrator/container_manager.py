...
class ContainerManager:
    ...
    def __init__(self, recon_image: str = "yousef_shtiwe-recon:latest", gvm_image: str = "yousef_shtiwe-vuln-scanner:latest", github_hunt_image: str = "yousef_shtiwe-github-hunter:latest", trufflehog_image: str = "yousef_shtiwe-trufflehog:latest"):
    ...
    def _get_container_name(self, project_id: str) -> str:
        ...
        return f"yousef_shtiwe-recon-{safe_id}"
        ...
        try:
            ...
            container = self.client.containers.run(
                ...
                volumes={
                    ...
                    "/tmp/yousef_shtiwe": {"bind": "/tmp/yousef_shtiwe", "mode": "rw"},
                    # JS Recon shared volumes with webapp
                    "yousef_shtiwe_js_recon_uploads": {"bind": "/data/js-recon-uploads", "mode": "ro"},
                    "yousef_shtiwe_js_recon_custom": {"bind": "/data/js-recon-custom", "mode": "ro"},
                },
    ...
    def _get_partial_container_name(self, project_id: str, run_id: str) -> str:
        ...
        safe_id = re.sub(r'[^a-zA-Z0-9_.-]', '_', project_id)
        return f"yousef_shtiwe-partial-recon-{safe_id}-{run_id[:8]}"
    ...
    async def start_partial_recon(
        ...
        try:
            ...
            # Write config JSON to /tmp/yousef_shtiwe/ (shared volume)
            import json
            config_dir = Path("/tmp/yousef_shtiwe")
            ...
            container = self.client.containers.run(
                ...
                environment={
                    ...
                    "PARTIAL_RECON_CONFIG": f"/tmp/yousef_shtiwe/partial_{project_id}_{run_id}.json",
    ...
    async def stop_partial_recon(self, project_id: str, run_id: str, timeout: int = 10) -> PartialReconState:
        ...
        try:
            config_path = Path(f"/tmp/yousef_shtiwe/partial_{project_id}_{run_id}.json")
    ...
    def _get_gvm_container_name(self, project_id: str) -> str:
        ...
        safe_id = re.sub(r'[^a-zA-Z0-9_.-]', '_', project_id)
        return f"yousef_shtiwe-gvm-{safe_id}"
        ...
        try:
            ...
            container = self.client.containers.run(
                ...
                volumes={
                    ...
                    "yousef_shtiwe_gvmd_socket": {"bind": "/run/gvmd", "mode": "ro"},
    ...
    def is_gvm_available(self) -> bool:
        ...
        try:
            container = self.client.containers.get("yousef_shtiwe-gvm-gvmd")
    ...
    def _get_github_hunt_container_name(self, project_id: str) -> str:
        ...
        safe_id = re.sub(r'[^a-zA-Z0-9_.-]', '_', project_id)
        return f"yousef_shtiwe-github-hunt-{safe_id}"
    ...
    def _get_trufflehog_container_name(self, project_id: str) -> str:
        ...
        safe_id = re.sub(r'[^a-zA-Z0-9_.-]', '_', project_id)
        return f"yousef_shtiwe-trufflehog-{safe_id}"
