...
_DOCS_BASE = "https://shadow-agent.nousresearch.com/docs"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://shadow-agent.nousresearch.com/docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://shadow-agent.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://shadow-agent.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
