...
class SkillManager:
    """Orchestrates YOUSEF SHTIWE's offensive toolset."""
    def __init__(self):
        self.tools = {
            "recon_subdomains": yousef shtiwe_recon_subdomains,
            "loot_file": yousef shtiwe_loot_file,
            "wipe_logs": yousef shtiwe_ghost_wipe,
