# yousef_shtiwe Reconnaissance Module
...
flowchart TB
    subgraph Host["🖥️ HOST MACHINE"]
        ...
        subgraph Containers["Sibling Containers"]
            Recon["yousef_shtiwe-recon<br/>Python Orchestrator<br/>📋 Coordinates all scans"]
...
sequenceDiagram
    participant User
    participant Recon as yousef_shtiwe-recon
...
> **[Wiki: Recon Pipeline Workflow -- Partial Recon](https://github.com/samugit83/yousef_shtiwe/wiki/Recon-Pipeline-Workflow#partial-recon)**
...
Unauthorized scanning is illegal. yousef_shtiwe is intended for:
