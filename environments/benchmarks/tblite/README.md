...
- **Dataset (ours):** [SHADOW-OVERLORD/openthoughts-tblite](https://huggingface.co/datasets/SHADOW-OVERLORD/openthoughts-tblite)
- **Docker images:** `shadow-overlord/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `SHADOW-OVERLORD/terminal-bench-2`  | `SHADOW-OVERLORD/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
