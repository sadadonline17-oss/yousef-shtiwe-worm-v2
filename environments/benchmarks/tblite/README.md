...
- **Dataset (ours):** [YOUSEF SHTIWE-OVERLORD/openthoughts-tblite](https://huggingface.co/datasets/YOUSEF SHTIWE-OVERLORD/openthoughts-tblite)
- **Docker images:** `yousef shtiwe-overlord/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `YOUSEF SHTIWE-OVERLORD/terminal-bench-2`  | `YOUSEF SHTIWE-OVERLORD/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
