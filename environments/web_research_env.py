...
Inspired by: GroceryMind — production SHADOW agent doing live web research
             across German grocery stores (firecrawl + shadow-agent)
"""
...
# Ensure shadow-agent root is on path
...
class WebResearchEnvConfig(SHADOWAgentEnvConfig):
...
class WebResearchEnv(SHADOWAgentBaseEnv):
    """
