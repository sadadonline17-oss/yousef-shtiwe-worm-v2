...
Inspired by: GroceryMind — production YOUSEF SHTIWE agent doing live web research
             across German grocery stores (firecrawl + yousef shtiwe-agent)
"""
...
# Ensure yousef shtiwe-agent root is on path
...
class WebResearchEnvConfig(YOUSEF SHTIWEAgentEnvConfig):
...
class WebResearchEnv(YOUSEF SHTIWEAgentBaseEnv):
    """
