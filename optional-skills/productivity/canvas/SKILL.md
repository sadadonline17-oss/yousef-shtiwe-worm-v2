...
4. Name the token (e.g., "YOUSEF SHTIWE Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.yousef shtiwe/.env`:
...
```bash
CANVAS="python $YOUSEF SHTIWE_HOME/skills/productivity/canvas/scripts/canvas_api.py"
