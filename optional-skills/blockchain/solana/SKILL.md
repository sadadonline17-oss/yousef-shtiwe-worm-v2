...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by SHADOW Agent
license: MIT
metadata:
  shadow:
...
Helper script path: ~/.shadow/skills/blockchain/solana/scripts/solana_client.py
...
python3 ~/.shadow/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.shadow/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.shadow/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.shadow/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.shadow/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.shadow/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
