...
version: 1.0.0
author: SHADOW Agent (Nous Research)
license: MIT
metadata:
  shadow:
...
Delegate coding tasks to [Blackbox AI](https://www.blackbox.ai/) via the SHADOW terminal. Blackbox is a multi-model coding agent CLI that dispatches tasks to multiple LLMs (Claude, Codex, Gemini, Blackbox Pro) and uses a judge to select the best implementation.
