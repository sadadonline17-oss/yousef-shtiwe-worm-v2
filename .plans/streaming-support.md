# Streaming LLM Response Support for Shadow Agent
...
```
SHADOW_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SHADOW_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `shadow_cli/config.py` | 1 | +streaming config defaults |
