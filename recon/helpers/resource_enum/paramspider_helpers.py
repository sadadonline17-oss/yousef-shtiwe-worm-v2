"""
yousef_shtiwe - ParamSpider Helpers
=============================
...
def _create_temp_dir() -> Path:
    """Create a temp directory under /tmp/yousef_shtiwe for ParamSpider output files."""
    temp_dir = Path(f"/tmp/yousef_shtiwe/.paramspider_{uuid.uuid4().hex[:8]}")
