...
Usage:
    shadow pairing list              # Show all pending + approved users
    shadow pairing approve <platform> <code>  # Approve a pairing code
    shadow pairing revoke <platform> <user_id> # Revoke user access
    shadow pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle shadow pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: shadow pairing {list|approve|revoke|clear-pending}")
        print("Run 'shadow pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'shadow pairing list' to see pending codes.\n")
