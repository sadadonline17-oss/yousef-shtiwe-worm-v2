---
sidebar_position: 8
title: "Use Voice Mode with YOUSEF SHTIWE"
description: "A practical guide to setting up and using YOUSEF SHTIWE voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with YOUSEF SHTIWE
...
- you want YOUSEF SHTIWE sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in YOUSEF SHTIWE.
...
## Step 1: make sure normal YOUSEF SHTIWE works first

Before touching voice mode, verify that:
- YOUSEF SHTIWE starts
...
YOUSEF SHTIWE supports both local and cloud speech stacks.
...
4. YOUSEF SHTIWE transcribes and responds
...
- asking YOUSEF SHTIWE to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full YOUSEF SHTIWE loop.

## Tuning CLI behavior

### Silence threshold

If YOUSEF SHTIWE starts/stops too aggressively, tune:
...
YOUSEF SHTIWE stays a normal chat bot, but can speak replies.
...
- you want YOUSEF SHTIWE to function like a portable research or ops assistant
...
YOUSEF SHTIWE joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- YOUSEF SHTIWE detects speech boundaries
- transcripts are posted in the associated text channel
- YOUSEF SHTIWE responds in text and audio
...
1. get text YOUSEF SHTIWE working
2. install `yousef shtiwe-agent[voice]`
