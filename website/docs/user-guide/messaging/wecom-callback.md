...
Connect YOUSEF SHTIWE to WeCom (Enterprise WeChat) as a self-built enterprise application using the callback/webhook model.

:::info WeCom Bot vs WeCom Callback
YOUSEF SHTIWE supports two WeCom integration modes:
...
3. YOUSEF SHTIWE decrypts the message, queues it for the agent
