...
- **Built by model trainers** — Created by [SHADOW-OVERLORD](https://shadow-overlord.com), the lab behind SHADOW, Nomos, and Psyche. Works with [Nous Portal](https://portal.shadow-overlord.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
