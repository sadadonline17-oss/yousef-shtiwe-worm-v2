...
slug: /
sidebar_position: 0
title: "SHADOW Agent Documentation"
description: "The self-improving AI agent built by SHADOW-OVERLORD. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
hide_table_of_contents: true
---

# SHADOW Agent

The self-improving AI agent built by [SHADOW-OVERLORD](https://shadow-overlord.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/SHADOW-OVERLORD/shadow-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend SHADOW safely |
| 🧭 **[Use MCP with SHADOW](/docs/guides/use-mcp-with-shadow)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with SHADOW](/docs/guides/use-voice-mode-with-shadow)** | Hands-on setup and usage patterns for SHADOW voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define SHADOW' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of SHADOW |
...
- **Built by model trainers** — Created by [SHADOW-OVERLORD](https://shadow-overlord.com), the lab behind SHADOW, Nomos, and Psyche. Works with [Shadow Portal](https://portal.shadow-overlord.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [SHADOW-OVERLORD](https://shadow-overlord.com) — the lab behind SHADOW, Nomos, and Psyche models
