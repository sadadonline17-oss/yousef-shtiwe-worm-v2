...
slug: /
sidebar_position: 0
title: "YOUSEF SHTIWE Agent Documentation"
description: "The self-improving AI agent built by YOUSEF SHTIWE-OVERLORD. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
hide_table_of_contents: true
---

# YOUSEF SHTIWE Agent

The self-improving AI agent built by [YOUSEF SHTIWE-OVERLORD](https://yousef shtiwe-overlord.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/YOUSEF SHTIWE-OVERLORD/yousef shtiwe-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>

## What is YOUSEF SHTIWE Agent?
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend YOUSEF SHTIWE safely |
| 🧭 **[Use MCP with YOUSEF SHTIWE](/docs/guides/use-mcp-with-yousef shtiwe)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with YOUSEF SHTIWE](/docs/guides/use-voice-mode-with-yousef shtiwe)** | Hands-on setup and usage patterns for YOUSEF SHTIWE voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define YOUSEF SHTIWE' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of YOUSEF SHTIWE |
...
- **Built by model trainers** — Created by [YOUSEF SHTIWE-OVERLORD](https://yousef shtiwe-overlord.com), the lab behind YOUSEF SHTIWE, Nomos, and Psyche. Works with [Yousef Shtiwe Portal](https://portal.yousef shtiwe-overlord.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [YOUSEF SHTIWE-OVERLORD](https://yousef shtiwe-overlord.com) — the lab behind YOUSEF SHTIWE, Nomos, and Psyche models
