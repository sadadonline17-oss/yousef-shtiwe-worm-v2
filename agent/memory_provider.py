...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - yousef shtiwe_home (str): The active YOUSEF SHTIWE_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.yousef shtiwe``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "yousef shtiwe").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'yousef shtiwe memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], yousef shtiwe_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'yousef shtiwe memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``yousef shtiwe_home`` is the active YOUSEF SHTIWE_HOME directory path.
