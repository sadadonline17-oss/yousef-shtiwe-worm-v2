...
class SSHEnvironment(BaseEnvironment):
    ...
    def __init__(self, host: str, user: str, cwd: str = "~",
        ...
        self.control_dir = Path(tempfile.gettempdir()) / "yousef shtiwe-ssh"
    ...
    def _ensure_remote_dirs(self) -> None:
        """Create base ~/.yousef shtiwe directory tree on remote in one SSH call."""
        base = f"{self._remote_home}/.yousef shtiwe"
    ...
    def _ssh_bulk_upload(self, files: list[tuple[str, str]]) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="yousef shtiwe-ssh-bulk-") as staging:
