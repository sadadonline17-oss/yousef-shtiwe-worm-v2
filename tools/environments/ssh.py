...
class SSHEnvironment(BaseEnvironment):
    ...
    def __init__(self, host: str, user: str, cwd: str = "~",
        ...
        self.control_dir = Path(tempfile.gettempdir()) / "shadow-ssh"
    ...
    def _ensure_remote_dirs(self) -> None:
        """Create base ~/.shadow directory tree on remote in one SSH call."""
        base = f"{self._remote_home}/.shadow"
    ...
    def _ssh_bulk_upload(self, files: list[tuple[str, str]]) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="shadow-ssh-bulk-") as staging:
