"""
Email platform adapter for the SHADOW gateway.

Allows users to interact with SHADOW by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "SHADOW Agent")
        ...
        msg_id = f"<shadow-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
