"""
Email platform adapter for the YOUSEF SHTIWE gateway.

Allows users to interact with YOUSEF SHTIWE by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "YOUSEF SHTIWE Agent")
        ...
        msg_id = f"<yousef shtiwe-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
