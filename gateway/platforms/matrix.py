...
# Uses get_yousef shtiwe_home() so each profile gets its own Matrix store.
from yousef shtiwe_constants import get_yousef shtiwe_dir as _get_yousef shtiwe_dir
_STORE_DIR = _get_yousef shtiwe_dir("platforms/matrix/store", "matrix/store")
...
class MatrixAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = float(os.getenv("YOUSEF SHTIWE_MATRIX_TEXT_BATCH_DELAY_SECONDS", "0.6"))
        self._text_batch_split_delay_seconds = float(os.getenv("YOUSEF SHTIWE_MATRIX_TEXT_BATCH_SPLIT_DELAY_SECONDS", "2.0"))
    ...
    async def connect(self) -> bool:
        ...
        if self._access_token:
            ...
            try:
                resp = await client.login(
                    ...
                    device_name="YOUSEF SHTIWE Agent",
                    device_id=self._device_id or None,
                )
        ...
        if self._encryption:
            ...
            try:
                ...
                _acct_id = self._user_id or "yousef shtiwe"
