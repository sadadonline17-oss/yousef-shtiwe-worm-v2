...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_shadow_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/shadow")
            async def handle_shadow_command(ack, command):
                await ack()
            ...
            for _action_id in (
                "shadow_approve_once",
                "shadow_approve_session",
                "shadow_approve_always",
                "shadow_deny",
            ):
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "shadow_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "shadow_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "shadow_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "shadow_approve_once": "once",
            "shadow_approve_session": "session",
            "shadow_approve_always": "always",
            "shadow_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from shadow_cli.commands import slack_subcommand_map
