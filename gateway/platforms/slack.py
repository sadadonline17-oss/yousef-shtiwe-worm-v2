...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_yousef shtiwe_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/yousef shtiwe")
            async def handle_yousef shtiwe_command(ack, command):
                await ack()
                await self._handle_slash_command(command)

            # Register Block Kit action handlers for approval buttons
            for _action_id in (
                "yousef shtiwe_approve_once",
                "yousef shtiwe_approve_session",
                "yousef shtiwe_approve_always",
                "yousef shtiwe_deny",
            ):
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "yousef shtiwe_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "yousef shtiwe_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "yousef shtiwe_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "yousef shtiwe_approve_once": "once",
            "yousef shtiwe_approve_session": "session",
            "yousef shtiwe_approve_always": "always",
            "yousef shtiwe_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        """Handle /yousef shtiwe slash command."""
        ...
        from yousef shtiwe_cli.commands import slack_subcommand_map
